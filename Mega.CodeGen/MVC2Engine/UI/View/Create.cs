...
namespace Mega.CodeGen.MVC2Engine
{
    public class Create
    {
        public bool CreateMethod(IList<clsTableRefEntity> objclsTableRefEntityList, IList<clsColumnEntity> objclsColumnEntityList, string nameSpace, string tableName, string path, string DataBaseName)
        {
        ...
        private string GenerateString(IList<clsTableRefEntity> objclsTableRefEntityList, IList<clsColumnEntity> objclsColumnEntityList, string nameSpace, string tableName, string DataBaseName)
        {
            ...
            strQry += "\t\t\tLoadForm" + tableName + "_CreatePage();\n";
            strQry += "\t\t});\n";
            strQry += "\t</script>\n";
            strQry += "</asp:Content>\n";
            ...
            strQry += "\t\t\t\t\t\t<input type=\"button\" class=\"save\" id=\"btnSave\" value=\"Save\" />\n";
